...
The schema includes inline descriptions in Sinhala for each field, serving as implicit instructions to the model. For example, \texttt{"letter\_type": "ලිපි වර්ගය (application/request/complaint)"} indicates both the field name and expected categories.
