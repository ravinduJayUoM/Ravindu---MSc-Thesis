...
\begin{itemize}
    \item \textbf{Model:} Aya 8B multilingual LLM without retrieval augmentation
...
\begin{itemize}
    \item \textbf{Model:} Aya 8B multilingual LLM with full RAG pipeline
    ...
    \item \textbf{Purpose:} Tests whether retrieval-augmented approach compensates for limited Sinhala training data
\end{itemize}
...
\begin{enumerate}
    \item Generate letter using baseline Aya 8B (control condition)
    \item Generate letter using full RAG pipeline (experimental condition)
